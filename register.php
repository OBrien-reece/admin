                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="action.php" enctype="multipart/form-data">
                            ...
                            ?>
                                ...
                                <button name="registerAccountBtn" type="submit" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </button>
                                <hr>
